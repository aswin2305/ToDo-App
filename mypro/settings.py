...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # Put immediately after SecurityMiddleware
...
# WhiteNoise storage backend for optimized serving (optional but recommended)
